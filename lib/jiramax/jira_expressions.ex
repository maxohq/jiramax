defmodule Jiramax.JiraExpressions do
  @moduledoc """
  ...
  **[Permissions](#permissions) required**: None.
  ...
  """
  @spec analyse_expression(Jiramax.JiraExpressionForAnalysis.t(), keyword) ::
          {:ok, Jiramax.JiraExpressionsAnalysis.t()} | {:error, Jiramax.ErrorCollection.t()}
  def analyse_expression(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Jiramax.JiraExpressions, :analyse_expression},
      url: "/rest/api/3/expression/analyse",
      body: body,
      method: :post,
      query: query,
      request: [{"application/json", {Jiramax.JiraExpressionForAnalysis, :t}}],
      response: [
        {200, {Jiramax.JiraExpressionsAnalysis, :t}},
  ...
  **[Permissions](#permissions) required**: None. However, an expression may return different results for different users depending on their permissions. For example, different users may see different comments on the same issue.  
  ...
  """
  @spec evaluate_jira_expression(Jiramax.JiraExpressionEvalRequestBean.t(), keyword) ::
          {:ok, Jiramax.JiraExpressionResult.t()} | {:error, Jiramax.ErrorCollection.t()}
  def evaluate_jira_expression(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Jiramax.JiraExpressions, :evaluate_jira_expression},
      url: "/rest/api/3/expression/eval",
      body: body,
      method: :post,
      query: query,
      request: [{"application/json", {Jiramax.JiraExpressionEvalRequestBean, :t}}],
      response: [
        {200, {Jiramax.JiraExpressionResult, :t}},
        {400, {Jiramax.ErrorCollection, :t}},
        {401, :null},
        {404, {Jiramax.ErrorCollection, :t}}
      ],
