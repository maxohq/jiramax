defmodule Jiramax.Workflows do
  @moduledoc """
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  """
  @spec create_workflow(Jiramax.CreateWorkflowDetails.t(), keyword) ::
          {:ok, Jiramax.WorkflowIds.t()} | {:error, nil}
  def create_workflow(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Jiramax.Workflows, :create_workflow},
      url: "/rest/api/3/workflow",
      body: body,
      method: :post,
      request: [{"application/json", {Jiramax.CreateWorkflowDetails, :t}}],
      response: [
        {201, {Jiramax.WorkflowIds, :t}},
        {400, {:const, nil}},
        {401, :null},
        {403, {:const, nil}},
        {404, {:const, nil}}
  ...
  **[Permissions](#permissions) required:**
  ...
  """
  @spec create_workflows(Jiramax.WorkflowCreateRequest.t(), keyword) ::
          {:ok, Jiramax.WorkflowCreateResponse.t()} | :error
  def create_workflows(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Jiramax.Workflows, :create_workflows},
      url: "/rest/api/3/workflows/create",
      body: body,
      method: :post,
      request: [{"application/json", {Jiramax.WorkflowCreateRequest, :t}}],
      response: [{200, {Jiramax.WorkflowCreateResponse, :t}}, {400, :null}, {401, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  """
  @spec delete_inactive_workflow(String.t(), keyword) :: :ok | {:error, nil}
  def delete_inactive_workflow(entityId, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [entityId: entityId],
      call: {Jiramax.Workflows, :delete_inactive_workflow},
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  """
  @spec get_all_workflows(keyword) :: {:ok, [Jiramax.DeprecatedWorkflow.t()]} | :error
  def get_all_workflows(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jiramax.Workflows, :get_all_workflows},
      url: "/rest/api/3/workflow",
      method: :get,
      query: query,
      response: [{200, [{Jiramax.DeprecatedWorkflow, :t}]}, {401, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
  ...
  @spec get_workflows_paginated(keyword) ::
          {:ok, Jiramax.PageBeanWorkflow.t()} | {:error, Jiramax.ErrorCollection.t()}
  def get_workflows_paginated(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jiramax.Workflows, :get_workflows_paginated},
      url: "/rest/api/3/workflow/search",
      method: :get,
      query: query,
      response: [
        {200, {Jiramax.PageBeanWorkflow, :t}},
        {401, :null},
  ...
  **[Permissions](#permissions) required:**
  ...
  """
  @spec read_workflows(Jiramax.WorkflowReadRequest.t(), keyword) ::
          {:ok, Jiramax.WorkflowReadResponse.t()} | :error
  def read_workflows(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Jiramax.Workflows, :read_workflows},
      url: "/rest/api/3/workflows",
      body: body,
      method: :post,
      query: query,
      request: [{"application/json", {Jiramax.WorkflowReadRequest, :t}}],
      response: [{200, {Jiramax.WorkflowReadResponse, :t}}, {400, :null}, {401, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:**
  ...
  """
  @spec update_workflows(Jiramax.WorkflowUpdateRequest.t(), keyword) ::
          {:ok, Jiramax.WorkflowUpdateResponse.t()} | :error
  def update_workflows(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Jiramax.Workflows, :update_workflows},
      url: "/rest/api/3/workflows/update",
      body: body,
      method: :post,
      query: query,
      request: [{"application/json", {Jiramax.WorkflowUpdateRequest, :t}}],
      response: [{200, {Jiramax.WorkflowUpdateResponse, :t}}, {400, :null}, {401, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:**
   ...
   *  *Administer projects* project permissions to create project-scoped workflows
  """
  @spec validate_create_workflows(Jiramax.WorkflowCreateValidateRequest.t(), keyword) ::
          {:ok, Jiramax.WorkflowValidationErrorList.t()} | :error
  def validate_create_workflows(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Jiramax.Workflows, :validate_create_workflows},
      url: "/rest/api/3/workflows/create/validation",
      body: body,
      method: :post,
      request: [{"application/json", {Jiramax.WorkflowCreateValidateRequest, :t}}],
      response: [{200, {Jiramax.WorkflowValidationErrorList, :t}}, {400, :null}, {401, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:**
   ...
   *  *Administer projects* project permissions to create project-scoped workflows
  """
  @spec validate_update_workflows(Jiramax.WorkflowUpdateValidateRequestBean.t(), keyword) ::
          {:ok, Jiramax.WorkflowValidationErrorList.t()} | :error
  def validate_update_workflows(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Jiramax.Workflows, :validate_update_workflows},
      url: "/rest/api/3/workflows/update/validation",
      body: body,
      method: :post,
      request: [{"application/json", {Jiramax.WorkflowUpdateValidateRequestBean, :t}}],
      response: [{200, {Jiramax.WorkflowValidationErrorList, :t}}, {400, :null}, {401, :null}],
      opts: opts
    })
  end
  ...
  **[Permissions](#permissions) required:**
  ...
  """
  @spec workflow_capabilities(keyword) :: {:ok, Jiramax.WorkflowCapabilities.t()} | :error
  def workflow_capabilities(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Jiramax.Workflows, :workflow_capabilities},
      url: "/rest/api/3/workflows/capabilities",
      method: :get,
      query: query,
      response: [{200, {Jiramax.WorkflowCapabilities, :t}}, {400, :null}, {401, :null}],
      opts: opts
    })
  end
end
